...
??? question "IntelliJ et VS Code offrent-ils les mêmes fonctionnalités Copilot ?"
    ...
    Voir la [Comparaison des problèmes](../chapitre-10-troubleshooting/comparaison-problemes.md) pour la matrice complète.
...
??? question "Pourquoi Copilot ne génère-t-il pas de suggestions dans un fichier ?"
    ...
    Voir [Problèmes courants](../chapitre-10-troubleshooting/problemes-courants.md) pour les solutions détaillées.
...
??? question "Comment lire les logs Copilot ?"
    ...
    Voir [Logs & Diagnostic](../chapitre-10-troubleshooting/logs-diagnostic.md) pour le guide complet.
